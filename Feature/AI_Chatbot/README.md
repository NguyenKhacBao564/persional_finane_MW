# AI Chatbot Module (WIP)

This directory will house the upcoming AI chatbot feature. Suggested layout:

- `services/` for providers and orchestration logic.
- `routes/` for Express adapters that expose chatbot endpoints.
